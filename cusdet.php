...
$no_of_bill_sql="SELECT count( * ) as no_of_bill FROM `sales_bill` 
WHERE shop_name='$cname'";
...
$salesbill_sql="SELECT SUM(net_amt) AS amt_purchased FROM sales_bill WHERE shop_name='$cname';";
...
<div class="billdet" id="bill" style="visibility: hidden;">
        <table>
            <tr>
                ...
                <?php
                    $sql1="SELECT * FROM sales_bill WHERE shop_name='$cname'";
    ...
    <table>
        <tr>
            ...
            <th>Recived By</th>
                ...
                <?php
                    $sql1="SELECT * FROM sales_recipt WHERE shop_name='$cname'";
                    $res1=mysqli_query($conn,$sql1);
                    while($row4=mysqli_fetch_array($res1,MYSQLI_ASSOC)){
